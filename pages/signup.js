      ...
      <div className='relative w-[380px] h-[650px] bg-gray-800 rounded-tr-3xl rounded-bl-3xl overflow-hidden'>
        ...
        <div className='absolute inset-1 bg-gray-800 rounded-tr-3xl rounded-bl-3xl z-10 p-5'>
          <form className='flex-col space-y-8'>
            <h2 className='text-xl font-semibold text-lime-500 text-center'>Sign up as a student</h2>
            {
              isErrorOccured && (
            ...
            <div>
             <h7 className='text-l font-semibold text-lime-500 text-center'>Signup as an instructor <Link href='/instructor_signup'><u>Signup</u></Link></h7>
            </div>
          </form>
        </div>
      </div>
