...
=======
        `SELECT DISTINCT "Users"."name", "Users"."email", TO_CHAR("Users"."reg_date", 'DD Month, YYYY') "reg_date", TO_CHAR("Students"."date_of_birth", 'DD Month, YYYY') "date_of_birth", "Students"."gender", COUNT("Enrolls"."c_id") "course_count"
>>>>>>> 93add98faef29bf41fa9ab12bbeb79621d733d4e
